...
WITH top_paying_jobs AS( -- using CTE
SELECT
    job_id,
    job_title,
    salary_year_avg,
...
Tableau is also highly sought after witha  bold count of 6.
Otehr skills like R, Snowflake ,Pandas and Excel show varyinf degrees of demang.
